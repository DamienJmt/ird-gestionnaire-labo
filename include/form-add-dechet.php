<div class="flex-form">    
    <form action="fonctions/ajouter_dechet.php" method="post">
            ...
            <div>
                <p>(Le numéro du déchet sera ajouté automatiquement)</p>
            </div>
            ...
            <div>            
                <div class="b">
                    ...
                    <input onclick="return confirm('Ajouter ce(s) déchet(s) ?');" class="bouton-add" type="submit" value="Ajouter">
                </div>
            </div>
